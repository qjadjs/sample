...
public class UploadController {
	...
	// 원래는 byte[] 배열로 처리 해야 하지만 spring 에서 조금더 쉽게 할수 있도록 Resource
	...
	public ResponseEntity<Resource> downloadFile(String fileName) {
		...
		// 이 경로를 통해 요청하게 되면 브라우저는 자동으로 해당 파일을 다운로드하도록 하게 된다.
	...
	// 우리가 생각해야 할점 : 섬네일이미지의 이름  '파일경로' + 's_' + 'uuid' + '파일의 원래이름'
	// 그리고 한글 처리까지 
	...
	// 어노테이션에 이 메소드가 어떤 데이터를 제공할지도 정해준다. produces << 속성 사용하면됨
	...
	private boolean checkImageType(File file) {
		...
		// 파라미터로 받아온 file이 이미지 파일이 아니면 return false;
